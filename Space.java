...
public class Space {
    ...
    public void moveAllItems() {
        ...
        for (BaseObject bo:getAllItems()) bo.move();
    }
    ...
    public List<BaseObject> getAllItems() {
        ...
        list.add(ship);
        for (Ufo u:ufos) list.add(u);
        for (Rocket r:rockets) list.add(r);
        for (Bomb b:bombs) list.add(b);
        return list;
    }
    ...
    public void createUfo() {
        ...
        if (ufos.isEmpty()) ufos.add(new Ufo(1,1));
    }
    ...
    public void removeDead() {
        ...
        Iterator<Ufo> itU = ufos.iterator();
        while (itU.hasNext()) if (!itU.next().isAlive()) itU.remove();
        Iterator<Bomb> itB = bombs.iterator();
        while (itB.hasNext()) if (!itB.next().isAlive()) itB.remove();
